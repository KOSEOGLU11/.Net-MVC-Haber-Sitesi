<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="muratyücedağ.news_times_web.web.index" %>
...
<body>
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav cl-effect-18" id="cl-effect-18">
							<li class="act"><a href="index.aspx" class="effect1 active">Ana Sayfa</a></li>
							<li><a href="admin.aspx">Admin Paneli</a></li>
						</ul>
					</div><!-- /.navbar-collapse -->
						...
						<li>
							<div class="banner-info-slider">
								...
								<p>
									...
									muscle pain and a sore throat.<span>By <i>ullamcoman</i> and <i>Micheal smithjos.</i></span>
								</p>
								<div class="more">
						...
						<li>
							<div class="banner-info-slider">
								...
								<p>
									...
									do eiusmod tempor incididunt ut labore et dolore magna aliqua.<span>By <i>laborisman</i> and <i>Adom smithjos.</i></span>
								</p>
								<div class="more">
									<a href="single.html" class="type-1">
										<span> Read More </span>
						...
						<li>
							<div class="banner-info-slider">
								...
								<p>
									...
									do eiusmod tempor incididunt ut labore et dolore magna aliqua.<span>By <i>ullamcoman</i> and <i>Micheal smithjos.</i></span>
								</p>
								<div class="more">
									<a href="single.html" class="type-1">
										<span> Read More </span>
    ...
    <div class="container" style="margin-top:15px;">
        <div class="banner-bottom-grids">
            <div class="col-md-2 banner-bottom-grid-left">

            </div>
            <div class="col-md-4 banner-bottom-grid-left">
                <p class="text-danger">
					Haberler
                </p>
            ...
            <div class="col-md-6 banner-bottom-grid-left" style="display:inline-block;">
				<div id="kurFiyatları">
				<script type="text/javascript">var kurlist = ",ONS,USD,EUR,GRA,"; var genislik = 290; var bbg = "00304e"; var yr = "000000"; var zbg = "f7f7f7"; var br = "00304e"; var by = "Döviz Fiyatları"</script><ins data-client-id="mb-095720171805"></ins><a id="bplnk" href="https://www.dovizfiyat.com">Döviz Fiyatları</a>
...
<!-- banner -->
	...
	<div class="footer-top">
		<div class="container">
			<p>
				at least 150 missing and there dead in landslide after monsoon
				rains in central Sri Lanka, officials say <a href="#">http//example.com</a>
			</p>
		</div>
	</div>
	<div class="footer">
			...
			<div class="footer-grids">
				<div class="col-md-4 footer-grid-left">
					...
					<ul>
						<li>
							<a href="#">
								the moment an unlimited #antares rocket exploded seconds after launch
								<i>http//example.com</i>
							</a><span>15 minutes ago</span>
						</li>
						<li>
							<a href="mailto:info@example.com" class="cols">@NASA</a> & <a href="mailto:info@example.com" class="cols">
								@orbital science
							</a> <a href="#">
								gathering data on failure #antares rocket bound
								for international space
							</a><span>45 minutes ago</span>
						</li>
						<li>
							<a href="#">
								ex-cabinet minister chris huhne loses legal challenge over $77,750
								court costs incurred in speeding points
							</a><span>1 day ago</span>
						</li>
					</ul>
				</div>
				<div class="col-md-4 footer-grid-left">
